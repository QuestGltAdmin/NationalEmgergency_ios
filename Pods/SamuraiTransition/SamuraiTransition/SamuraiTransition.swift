...
open class SamuraiTransition: NSObject {
    ...
    public var originFrame1 = CGRect.zero
    public var zanLineWidth: CGFloat = 0
...
extension SamuraiTransition: UIViewControllerTransitioningDelegate {
    ...
    public func animationController(forPresented presented: UIViewController, presenting: UIViewController, source: UIViewController) -> UIViewControllerAnimatedTransitioning? {
        ...
        originFrame1 = CGRect(
            x: originFrame1.origin.x + 20,
            y: originFrame1.origin.y + 20,
            width: originFrame1.size.width - 40,
            height: originFrame1.size.height - 40
        )
        return self
    }
